...
- If external secrets or native dependencies are found, HALT the execution process.
- Generate a strict `[PRE-FLIGHT WARNING]` checklist for the user.
- **Example:**
...
- Do NOT invoke `git push` or any deployment commands until the user explicitly confirms the checklist.
